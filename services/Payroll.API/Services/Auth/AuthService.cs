...
public class AuthService : IAuthService
{
    ...
    public async Task<AuthResponseDto> RegisterAsync(RegisterDto registerDto)
    {
        ...
        // Não exigir vínculo com EmployeeId no registro. Se no futuro for necessário,
        // a vinculação deverá ser feita via endpoint administrativo separado.
    ...
    public async Task<IEnumerable<UserDto>> GetAllUsersAsync()
    {
        ...
        foreach (var user in users)
        {
            ...
            var employeeName = user.EmployeeId.HasValue
                ? (await _context.Employees.FindAsync(user.EmployeeId.Value))?.FullName
                : null;
